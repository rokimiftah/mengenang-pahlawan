...
export function PointsBadge({
	...
	const summary = useQuery(api.points.getSummary, {});
	...
	const TooltipBody = (
		<div className="min-w-[220px]">
			...
			<div className="text-xs text-zinc-200/90">
				...
				<span className="font-semibold">{dailyRemaining}</span>
			</div>
			<div className="mt-1 text-[11px] text-zinc-300/90">
	...
	return (
		<Tooltip
			...
			classNames={{
				tooltip:
					"z-50 max-w-xs rounded-lg bg-zinc-900 px-3 py-2 text-zinc-50 text-xs shadow-lg ring-1 ring-black/20",
			}}
		>
			<button
				type="button"
			...
			>
				...
				<span
					...
					style={{
						...
						WebkitMask:
							"linear-gradient(to bottom, rgba(0,0,0,.8), rgba(0,0,0,0.2))",
						background:
							"radial-gradient(120% 100% at 0% 0%, rgba(255,255,255,.6), rgba(255,255,255,0) 60%)",
					}}
				/>
			</button>
		</Tooltip>
