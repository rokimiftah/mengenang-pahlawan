...
export function QuizResultEmail({
	...
	const pct =
		total > 0
			? Math.max(0, Math.min(100, Math.round((correct / total) * 100)))
			: 0;
			...
			<Body style={styles.main}>
				<Container style={styles.container}>
					<Section style={styles.header}>
						<Link
							href="https://mengenangpahlawan.web.id"
					...
					<Section style={styles.statsSection}>
						...
						<div style={styles.statItem}>
							...
							<Text style={styles.muted}>
								{practice
									? "Mode latihan — tidak menambah poin."
									: "Poin ditambahkan ke saldo Anda."}
							</Text>
						</div>
						...
						<div style={styles.statItem}>
							...
							<Text style={styles.muted}>
								Simpan email ini sebagai catatan progres Anda.
							</Text>
						</div>
					...
					<Section style={styles.ctaWrap}>
						...
						<Text style={styles.ctaHint}>
							Buka aplikasi untuk melanjutkan latihan atau memilih pahlawan
							lainnya.
						</Text>
					</Section>
					...
					<Section style={styles.footer}>
						<Text style={styles.footerText}>
							Terima kasih telah menjaga semangat mengenang pahlawan. 🇮🇩
						</Text>
						<Text style={styles.footerTiny}>
							Anda menerima email ini karena menggunakan fitur kuis di Mengenang
							Pahlawan. Jika ini bukan Anda, abaikan email ini.
						</Text>
					</Section>
				</Container>
			</Body>
